...
public class LibraryTester {
	...
	private ArrayList<LibraryBook> checkedOut;
	...
	void setUp() throws Exception {
		...
		checkedOut.add(new LibraryBook(9781843193319L, "Alan Burt Akers", "Transit to Scorpio"));
		checkedOut.add(new LibraryBook(9781843190004L, "Moyra Caldecott", "Weapons of the Wolfhound"));
	}
	...
	/**
	 * Check for proper lookup by ISBN
	 */
	@Test 
	public void testMediumLibraryLookupByIsbn () {
		mediumLib.checkout(9781843193319L, "Martin Luther King", 1, 1, 2002);
		assertEquals("Martin Luther King", mediumLib.lookup(9781843193319L));	
	}
	
	/**
	 * Test for lookup by Holder
	 */
	@Test
	public void testMediumLibraryLookupByHolder() {
		
		mediumLib.checkout(9781843193319L, "Martin Luther King", 1, 1, 2002);
		assertTrue (mediumLib.lookup("Martin Luther King").get(0).equals(checkedOut.get(0)));
	}
	
	/**
	 * Test lookup by ISBN on the medium library
	 */
	@Test
	public void testMediumLibraryCheckout()
	{
		mediumLib.checkout(9781843190004L, "John", 1, 1, 2002);
		assertEquals("John", mediumLib.lookup(9781843190004L));
	}
	
	/**
	 * Test the check-in by ISBN
	 */
	@Test
	public void testMediumLibraryCheckinByISBN()
	{
		mediumLib.checkout(9781843190004L, "John", 1, 1, 2002);
	...
	/**
	 * Test the medium library check-in by holder
	 */
	@Test
	public void testMediumLibraryCheckinByHolder()
	{
		mediumLib.checkout(9781843190004L, "John",1,1,2002);
		
		assertTrue(mediumLib.checkin("John"));
	}
